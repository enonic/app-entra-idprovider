...
createAndUpdateGroupsOnLoginFromGraphApi=  (true or false, optional, defaults to "false")
pageSize=  (number, optional)
groupPrefix=  (string, optional, defaults to "azure-ad-")
proxy.host=  (string, required)
proxy.port=  (number between 0 and 65535, optional)
proxy.user=  (string, optional)
proxy.password=  (string, optional)
groupFilter.[0..N].groupProperty=  (string, required)
groupFilter.[0..N].regexp=  (string, required)
groupFilter.[0..N].and=  (true or false, optional)
----
