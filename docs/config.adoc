...
<1> Allows you to customize the type of user events such as `login`, `create`, and `modify`.
...
<2> Allows you to disable user events or specify whether they should be distributed in the cluster or locally.
