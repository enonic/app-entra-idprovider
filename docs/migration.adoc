...
[source,ini]
----
idprovider.<name>.userEventPrefix=
----
...
To replicate the behavior of the legacy Azure ID Provider, use the following settings:
...
The `defaultGroups` property is not supported by the Entra ID Provider.
