...
NOTE:: `<tenantid>` placeholder must be replaced with your real tenant identifier.
...
[source,properties]
----
idprovider.<name>.logoutUrl=https://login.microsoftonline.com/<tenantid>/oauth2/v2.0/logout?post_logout_redirect_uri=https://yourdomain.com
----
...
[source,properties]
----
idprovider.<name>.endSession.url=https://login.microsoftonline.com/<tenantшd>/oauth2/v2.0/logout
...
.com.enonic.app.azureadidprovider.cfg
[source,properties]
----
autoinit=true
...
idprovider.azure.logoutUrl=https://login.microsoftonline.com/<your-tenant-id>/oauth2/v2.0/logout?post_logout_redirect_uri=https://yourdomain.com
